...
let removeRequestContactReceived = (io) => {
    ...
    io.on('connection', (socket) => {
      ...
      clients = pushSocketIdToArray(clients, currentUserId, socket.id)
        ...
        socket.on('remove_request_contact-received', (data) => { //socket.emit('add-new-contact',{contactId:targetId})
            ...
            if (clients[data.contactId]) {
                emitNotifyToArray(clients,data.contactId,io,'response_remove_request_contact_received',currentUser)
            }
        });
